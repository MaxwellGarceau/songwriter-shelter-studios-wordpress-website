...
{
    wp_enqueue_style('normalize', site_url('/wp-content/themes/songwriter-shelter-studios-wordpress/vendor/normalize.css'));
    ...
    wp_enqueue_style('bootstrap', site_url('wp-content/themes/songwriter-shelter-studios-wordpress/vendor/bootstrap/css/bootstrap.css'));
