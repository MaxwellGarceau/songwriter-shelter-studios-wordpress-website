...
var scrollingNav = new _scrollingNav.default(); // Scrolling Nav

var search = new _search.default(); // Search

var upvote = new _upvote.default(); // Upvote
...
function () {
  function ForumPosts() {
    _classCallCheck(this, ForumPosts);
  ...
  _createClass(ForumPosts, [{
    ...
    value: function events() {
      ...
      (0, _jquery.default)('.user-forum-posts').on('click', '.update-forum-post', this.updateUserPost.bind(this));
      (0, _jquery.default)('.user-forum-posts').on('click', '.edit-forum-post', this.editUserPost.bind(this));
      (0, _jquery.default)('.create-forum-post').on('click', this.createForumPost.bind(this));
    }
  }, {
    key: "toggleUserPosts",
    value: function toggleUserPosts(e) {
    ...
    key: "toggleCreatePosts",
    value: function toggleCreatePosts(e) {
      var thisSection = (0, _jquery.default)(e.target).parents('.forum-master-container__subsection');
    ...
    key: "editUserPost",
    value: function editUserPost(e) {
      var thisPost = (0, _jquery.default)(e.target).parents('li');
    ...
    key: "makeUserPostEditable",
    value: function makeUserPostEditable(thisPost) {
    ...
    key: "makeUserPostReadOnly",
    value: function makeUserPostReadOnly(thisPost) {
    ...
    key: "deleteUserPost",
    value: function deleteUserPost(e) {
      var thisSection = (0, _jquery.default)(e.target).parents('.forum-master-container__subsection');
      var thisPost = (0, _jquery.default)(e.target).parents('li');
      ...
      _jquery.default.ajax({
        ...
        success: function success(response) {
          ...
          if (response.userPostCount == 0) {
            (0, _jquery.default)('.forum-button__no-posts').html("You don't have any posts at the moment. Click the \"Create A Post\" button to make some!");
          }
        },
    ...
    key: "updateUserPost",
    value: function updateUserPost(e) {
      var _this = this;
      ...
      _jquery.default.ajax({
        ...
        data: ourUpdatedPost,
        success: function success(response) {
          _this.makeUserPostReadOnly(thisPost);
    ...
    value: function createForumPost(e) {
      ...
      _jquery.default.ajax({
        ...
        success: function success(response) {
          ...
          (0, _jquery.default)('.forum-button__no-posts').html('');
          (0, _jquery.default)("\n\t\t\t\t\t    <li data-id=\"".concat(response.id, "\" data-post-type=\"").concat(response.type, "\">\n\t\t\t\t\t      <input readonly class=\"user-posts__title\" value=\"").concat(response.title.raw, "\">\n\t\t\t\t\t      <br>\n\t\t\t\t\t      <textarea readonly class=\"user-posts__content\">").concat(response.content.raw, "</textarea>\n\t\t\t\t\t      <br>\n\t\t\t\t\t      <span class=\"edit-forum-post\"><i class=\"fa fa-pencil\" aria-hidden=\"true\"> Edit</i></span>\n\t\t\t\t\t      <span class=\"delete-forum-post\"><i class=\"fa fa-trash-o\" aria-hidden=\"true\"> Delete</i></span>\n\t\t\t\t\t      <span class=\"update-forum-post\"><i class=\"fa fa-arrow-right\" aria-hidden=\"true\"> Save</i></span>\n\t\t\t\t\t    <hr>\t\t\t\t\t\t      \n\t\t\t\t\t    </li>\n\t\t\t\t\t\t")).prependTo(thisSection.find('.user-forum-posts')).hide().slideDown(); // Update forum list in real time (could also do for delete if I have time)
          // $(`
...
var ParallaxEffect = function ParallaxEffect() {
  if (document.getElementById('home')) {
    var myWorkWP = new Waypoint({
      element: document.getElementById('services'),
      handler: function handler(direction) {
        if (direction === "down") {
          (0, _jquery.default)('#home').removeClass('home-content my-work-content about-content').addClass('my-work-content');
        } else (0, _jquery.default)('#home').removeClass('home-content my-work-content about-content').addClass('home-content');
      }
    });
...
var ScrollingNav = function ScrollingNav() {
  ...
  (0, _jquery.default)('.js-scroll-trigger').click(function () {
...
function () {
  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(songwriterData.root_url + '/wp-json/songwriter/v1/search?term=' + this.searchField.val(), function (results) {
        _this.resultsDiv.html("\n\t\t\t\t<div class=\"container\">\n\t\t\t\t\t<div class=\"row\">\n\t\t\t\t\t\t<div class=\"col-lg-3 text-container\">\n\t\t\t\t\t\t\t<h2 class=\"search-overlay__section-title\">Pages</h2>\n\t\t\t\t\t\t\t<div class=\"search-overlay__border\"></div>\n\t\t\t\t\t\t\t<div class=\"text-container__reset\">\n\t\t\t\t\t\t\t\t".concat(results.pageSection.length !== 0 ? '<ul class="link-list min-list">' : '<span>Sorry, no results</span>', "\n\t\t\t\t\t\t\t\t").concat(results.pageSection.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a>").concat(item.postType == 'post' ? " - ".concat(item.postDate) : '', "</li><br>");
        }).join(''), "\n\t\t\t\t\t\t\t\t").concat(results.pageSection.length == 0 ? '</ul>' : '', "\t\t\n\t\t\t\t\t\t\t</div>\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-lg-3 text-container\">\n\t\t\t\t\t\t\t<h2 class=\"search-overlay__section-title\">Songwriter Salon</h2>\n\t\t\t\t\t\t\t<div class=\"search-overlay__border\"></div>\n\t\t\t\t\t\t\t<div class=\"text-container__reset\">\n\t\t\t\t\t\t\t\t").concat(results.songwriterSalon.length !== 0 ? '<ul class="link-list min-list">' : "<span>Sorry, no results. <br> <a href=\"".concat(songwriterData.root_url, "/songwriter-shelter-studios-blog-pages/songwriter-salon-music-philosophy-in-the-21st-century/\">See all Songwriter Salon posts here.</a></span>"), "\n\t\t\t\t\t\t\t\t").concat(results.songwriterSalon.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> - ").concat(item.postDate, "</li><br>");
        }).join(''), "\n\t\t\t\t\t\t\t\t").concat(results.songwriterSalon.length == 0 ? '</ul>' : '', "\n\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-lg-3 text-container\">\n\t\t\t\t\t\t\t<h2 class=\"search-overlay__section-title\">Advice for Songwriters</h2>\n\t\t\t\t\t\t\t<div class=\"search-overlay__border\"></div>\n\t\t\t\t\t\t\t<div class=\"text-container__reset\">\n\t\t\t\t\t\t\t\t").concat(results.songwriterAdvice.length !== 0 ? '<ul class="link-list min-list">' : "<span>Sorry, no results. <br> <a href=\"".concat(songwriterData.root_url, "/songwriter-shelter-studios-blog-pages/songwriter-advice-from-a-nashville-music-producer/\">See all Advice for Songwriters posts here.</a></span>"), "\n\t\t\t\t\t\t\t\t").concat(results.songwriterAdvice.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> - ").concat(item.postDate, "</li><br>");
        }).join(''), "\n\t\t\t\t\t\t\t\t").concat(results.songwriterAdvice.length == 0 ? '</ul>' : '', "\t\t\n\t\t\t\t\t\t\t</div>\t\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"col-lg-3 text-container text-container--last-container\">\n\t\t\t\t\t\t\t<h2 class=\"search-overlay__section-title\">Music Production</h2>\n\t\t\t\t\t\t\t<div class=\"search-overlay__border\"></div>\n\t\t\t\t\t\t\t<div class=\"text-container__reset\">\n\t\t\t\t\t\t\t\t").concat(results.productionTutorials.length !== 0 ? '<ul class="link-list min-list">' : "<span>Sorry, no results. <br> <a href=\"".concat(songwriterData.root_url, "/songwriter-shelter-studios-blog-pages/modern-music-production-and-composition-a-deep-dive-into-the-why-and-the-how/\">See all Music Production and Composition Tutorial posts here.</a></span>"), "\n\t\t\t\t\t\t\t\t").concat(results.productionTutorials.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> - ").concat(item.postDate, "</li><br>");
        }).join(''), "\n\t\t\t\t\t\t\t\t").concat(results.productionTutorials.length == 0 ? '</ul>' : '', "\t\n\t\t\t\t\t\t\t</div>\t\t\n\t\t\t\t\t\t</div>\t\t\t\t\t\t\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t"));
      });
    ...
    value: function keyPressDispatcher(e) {
      switch (e.keyCode) {
        case 83:
          !this.isOverlayOpen && !(0, _jquery.default)('input, textarea').is(':focus') ? this.openOverlay() : null;
          break;
...
function () {
  ...
  _createClass(Upvote, [{
    key: "events",
    value: function events() {
      (0, _jquery.default)('.upvote-box').on('click', this.ourClickDispatcher.bind(this));
    ...
    value: function ourClickDispatcher(e) {
      var currentUpvoteBox = (0, _jquery.default)(e.target).closest('.upvote-box');
    ...
    key: "createUpvote",
    value: function createUpvote(currentUpvoteBox) {
      _jquery.default.ajax({
        beforeSend: function beforeSend(xhr) {
          xhr.setRequestHeader('X-WP-NONCE', songwriterData.nonce);
        },
        ...
        type: 'POST',
        data: {
          'postId': currentUpvoteBox.data('post')
        },
        success: function success(response) {
          // Visually updates Upvote box and count
          currentUpvoteBox.attr('data-exists', 'yes');
          var upvoteCount = parseInt(currentUpvoteBox.find('.upvote-count').html(), 10);
          upvoteCount++;
          currentUpvoteBox.find('.upvote-count').html(upvoteCount); // Sends back post ID
    ...
    key: "deleteUpvote",
    value: function deleteUpvote(currentUpvoteBox) {
      _jquery.default.ajax({
        beforeSend: function beforeSend(xhr) {
          xhr.setRequestHeader('X-WP-NONCE', songwriterData.nonce);
        },
        ...
        type: 'DELETE',
        data: {
          'upvote': currentUpvoteBox.attr('data-upvote')
        },
        success: function success(response) {
          // Visually updates upvote box and count
