...
<div class="page-links side-list__float-left">
      ...
      <div class="page-links__title"><a href="<?php echo get_post_type_archive_link('songwriter-advice') ?>">Songwriter Advice From A Nashville Music Producer Archive</a></div>
      <ul class="min-list">
        <?php
        while ($songwriterAdvice->have_posts()) {
          $songwriterAdvice->the_post();
          ?>
